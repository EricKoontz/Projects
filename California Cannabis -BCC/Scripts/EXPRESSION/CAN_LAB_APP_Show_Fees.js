...
if (vDollar.value != null && vDollar.value != "") {
	if (vDollar.value == "Up to 50 million") {
		vFeeCode = "CAN_LAB_050";
	}
	if (vDollar.value == "Greater than 50 million to 500 million") {
		vFeeCode = "CAN_LAB_051";
	}
	if (vDollar.value == "Greater than 500 million") {
		vFeeCode = "CAN_LAB_052";
	}

	vFeeAmt = getRefFeeCalcFormula(vFeeCode, "CAN_LAB_FEE");
