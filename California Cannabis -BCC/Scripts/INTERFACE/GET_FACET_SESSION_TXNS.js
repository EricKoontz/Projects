...
"F4PAYMENT payment " +
    ...
    "LEFT JOIN F4CASHIER_SESSION cashier_session" +
    "   ON (payment.serv_prov_code = cashier_session.serv_prov_code " +
    "   AND payment.SESSION_NBR = cashier_session.SESSION_NBR)" +
...
//This temporarily disables this SQL statement. Remove the 1 = 2 to restore the functionality
"AND 1 = 2 " +
...
"F4PAYMENT payment " +
    ...
    "   AND payment.B1_PER_ID2 = base_to_parent.B1_PER_ID2 " +
    "   AND payment.B1_PER_ID3 = base_to_parent.B1_PER_ID3 " +
    "   AND base_to_parent.B1_RELATIONSHIP = 'Amendment') " +
    "LEFT JOIN B1PERMIT parent_record " +
    "   ON (base_to_parent.MASTER_SERV_PROV_CODE = parent_record.SERV_PROV_CODE " +
    "   AND base_to_parent.B1_MASTER_ID1 = parent_record.B1_PER_ID1 " +
    "   AND base_to_parent.B1_MASTER_ID2 = parent_record.B1_PER_ID2 " +
