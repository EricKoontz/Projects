...
try {
//skip page if CEO requestng temp us 2647
	var isTemporaryRequest = appMatch("Licenses/Cannabis/Event Organizer/Application") && isASITrue(AInfo["Are you requesting a temporary license?"]); // see user story 340
